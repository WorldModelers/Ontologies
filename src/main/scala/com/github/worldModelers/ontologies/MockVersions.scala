...
object MockVersions {
  ...
  val versions: Map[String, Option[MockVersion]] = Map(
    "wm_metadata.yml" -> Some(MockVersion("8c3d191c837e973a9ebfacaa78d3a96ab1701981", ZonedDateTime.parse("2019-10-04T17:18:20Z"))),
    "interventions_metadata.yml" -> Some(MockVersion("9fc7e0860cf54b7b54378bf3b73efe6e68e4e10b", ZonedDateTime.parse("2019-07-09T12:49:08Z")))
  )
}